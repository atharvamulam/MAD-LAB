...
import 'package:ig/features/posts/presentation/widgets/image_video_view.dart';
import 'package:ig/features/posts/presentation/widgets/profile_info.dart';
import 'package:ig/features/providers/posts_provider.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Divider(),
        TextButton(onPressed: pickVideo, child: const Text('Pick Video')),
